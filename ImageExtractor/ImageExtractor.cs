...
{	
  ...
  public class Form1 : System.Windows.Forms.Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.trackBar1.Size = new System.Drawing.Size(1366, 768);
    ...
    private void SaveButton_Click(object sender, System.EventArgs e)
    {
      ...
      string fBitmapName = storagePath + Path.GetFileNameWithoutExtension( fileName ) 
        + "_" + counter.ToString();
      md.WriteBitmapBits( trackBar1.Value, 1366, 766, fBitmapName + ".bmp" );
    ...
    private void trackBar1_ValueChanged(object sender, System.EventArgs e)
    {
      ...
      counter++;
      md.WriteBitmapBits( trackBar1.Value, 1366, 768, fBitmapName );
      pictureBox1.Image = new Bitmap( fBitmapName );      
